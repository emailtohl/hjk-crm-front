...
@Component({
  selector: 'app-my-organization-edit',
  templateUrl: './my-organization-edit.component.html',
  styleUrls: ['./my-organization-edit.component.css']
})
export class MyOrganizationEditComponent implements OnInit {
  id: number;
